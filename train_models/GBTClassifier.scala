...
object GBTTrainer{
  ...
  def train_gbt(df: org.apache.spark.sql.DataFrame):Unit = {
    ...
    val n_features = weighted_df.select("features").head(0).size
    ...
    lr_model.save("saved/gbt_model.orc")
